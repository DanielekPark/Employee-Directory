...
======================================== */
  let employees = []
  const urlAPI =
    'https://randomuser.me/api/?results=12&inc=name,%20picture,%20email,%20location,%20phone,%20dob%20&noinfo%20&nat=US'
...
======================================== */
  ...
  //DISPLAYS EMPLOYEES ON A MODAL WINDOW WHEN A CARD IS CLICKED
  function displayModal(index) {
    ...
    let date = new Date(Date.parse(dob.date)).toLocaleDateString(
      navigator.language
    )
    const modalHTML = `
